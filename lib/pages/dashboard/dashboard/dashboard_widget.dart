  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Visibility(
          visible: _model.canShowDashboard,
          child: Column(
                              ...
                              children: [
                                      ...
                                      children: [
                                                                  ...
                                                                  child: Align(
                                                                    ...
                                                                    child: Text(
                                                                      valueOrDefault<
                                                                          String>(
                                                                        functions
                                                                            .getUserInitials(stackUsersRecord.displayName),
                                                                        '?',
                                                                      ),
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: wrapWithModel(
                                              model:
                                                  _model.liveEarningsDashModel,
                                              updateCallback: () =>
                                                  safeSetState(() {}),
                                              child: LiveEarningsDashWidget(
                                                yearlyGain: _model
                                                    .pvTotals?.liveGainThisYear,
                                                dailyGain: _model
                                                    .pvTotals?.liveGainPerDay,
                                                secondGain: _model.pvTotals!
                                                    .liveGainPerSecond,
                                                earningsToDate: _model.pvTotals!
                                                    .liveEarningsAsOfNow,
                                                propertiesCount:
                                                    _model.propertyCountState!,
                                              ),
                                            ),
                                          ),
                                        ),
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        16.0, 0.0, 16.0, 0.0),
                                    child: wrapWithModel(
                                      model: _model.portfolioScoreDashNEWModel,
                                      updateCallback: () => safeSetState(() {}),
                                      child: PortfolioScoreDashNEWWidget(
                                        portfolioScore:
                                            functions.computePortfolioScore(
                                                _model.pvTotals?.capitalValue,
                                                _model.pvTotals?.annualRent,
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 0.0, 16.0, 0.0),
                                  child: wrapWithModel(
                                    model: _model.capitalUpgradeModel,
                                    updateCallback: () => safeSetState(() {}),
                                    child: CapitalUpgradeWidget(),
                                  ),
                                ),
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                        ...
                                        children: [
                                              ...
                                              Align(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '638yfxgu' /* Your Retirement Goals */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelLarge
                                          ...
                                          FFButtonWidget(
                                            ...
                                            text: FFLocalizations.of(context)
                                                .getText(
                                              'bvapixh5' /* Edit Retirement goals */,
                                            ),
