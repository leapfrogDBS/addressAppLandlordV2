  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.portfolioSnapshot = functions
          .aggregatePortfolioFromProperties(_model.loadedProperties?.toList());
      safeSetState(() {});
      _model.propertiesLoaded = true;
      safeSetState(() {});
    });
                                                        ...
                                                        children: [
                                                          TextSpan(
                                                            text: FFLocalizations
                                                                    .of(context)
                                                                .getText(
                                                              'rh3tf37r' /* Add mortgage data to propertie... */,
                                                            ),
                                                        ...
                                                        children: [
                                                          TextSpan(
                                                            text: FFLocalizations
                                                                    .of(context)
                                                                .getText(
                                                              'ymkvk3mg' /* Add purchase prices to see ave... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelSmall
                              ...
                              itemBuilder: (context, listViewIndex) {
                                ...
                                return wrapWithModel(
                                  ...
                                  child: SinglePropertyWidget(
                                    ...
                                    propValue:
                                        listViewPropertiesRecord.estimatedValue,
                                    ...
                                    rentAmount: listViewPropertiesRecord
                                        .currentRentAmount,
                                    purchasePrice:
                                        listViewPropertiesRecord.purchasePrice,
                                  ),
                                );
                              },
                            );
