  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.outputTenancy = await queryTenanciesRecordOnce(
        ...
        queryBuilder: (tenanciesRecord) => tenanciesRecord
            .where(
              'isActive',
              isEqualTo: true,
            )
            .orderBy('tenancyStartDate', descending: true),
        singleRecord: true,
                                    ...
                                    child: InkWell(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          ...
                                          border: Border.all(
                                            color: Color(0xFFDCE4EA),
                                            width: _model.tabView == 'financial'
                                                ? 1.0
                                                : 0.0,
                                          ),
                                        ),
                                    ...
                                    child: InkWell(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          ...
                                          border: Border.all(
                                            color: Color(0xFFDCE4EA),
                                            width: _model.tabView == 'documents'
                                                ? 1.0
                                                : 0.0,
                                          ),
                                        ),
                                        ...
                                        children: [
                                          wrapWithModel(
                                            ...
                                            child: LiveEarningsPropertyWidget(
                                              ...
                                              periodLabel: _model.pvProjection!
                                                  .periodLabels.firstOrNull!,
                                            ),
                                          ),
                                        ],
                                      ),
                                      if (_model.hasActiveTenancy)
                                        StreamBuilder<List<TenanciesRecord>>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<TenanciesRecord>
                                                containerTenanciesRecordList =
                                                snapshot.data!;
                                            // Return an empty Container when the item does not exist.
                                            if (snapshot.data!.isEmpty) {
                                              return Container();
                                            }
                                            final containerTenanciesRecord =
                                                containerTenanciesRecordList
                                                        .isNotEmpty
                                                    ? containerTenanciesRecordList
                                                        .first
                                                                    ...
                                                                    AlignedTooltip(
                                                                      content:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          FFLocalizations.of(context)
                                                                              .getText(
                                                                            'a3esnhmg' /* Calculated using rental income... */,
                                                                          ),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodySmall
                                                                              .override(
                                                                  ...
                                                                  text:
                                                                    ...
                                                                    children: [
                                                                      TextSpan(
                                                                        text: valueOrDefault<
                                                                            String>(
                                                                          columnPropertyProjectionsRecord
                                                                              ?.yieldPct
                                                                              ?.firstOrNull
                                                                              ?.toString(),
                                                                          '0',
                                    ...
                                    children: [
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'h7zpbgtz' /* Projected Perfromance */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .titleLarge
                                                .override(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: wrapWithModel(
                                              model: _model.statsCombinedModel,
                                              updateCallback: () =>
                                                  safeSetState(() {}),
                                      ...
                                      StreamBuilder<List<EventsRecord>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return Container(
                                            ...
                                            height: 400.0,
                                            child:
                                                custom_widgets.RentDueCalendar(
                                              width: double.infinity,
                                              height: 400.0,
                                              rentDueDates: _model.rentDueDates,
                                              otherEventDates:
                                                  rentDueCalendarEventsRecordList
                                                      .map((e) => e.startDate)
                                                      .withoutNulls
                                              ...
                                              events:
                                                  rentDueCalendarEventsRecordList,
                                              rentAmount: _model.monthlyRental,
                                            ),
                                          );
                                        },
                                      ),
