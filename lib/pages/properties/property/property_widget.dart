  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.financialSummary = functions.calculateEstimatedAnnualGain(
          ...
          _model.pvProjection!.housePctUsed.firstOrNull!,
          functions
              .calculateTotalExpensesFromList(_model.getExpenses?.toList())!,
          _model.output!.purchasePrice,
          _model.output!.previousRentalIncome,
          _model.output!.previousExpenses,
          _model.projectionDoc!.capitalGains.firstOrNull!,
          _model.pvProjection!.rental.firstOrNull!);
      safeSetState(() {});
    });
    ...
    _model.expandableExpandableController2 =
        ExpandableController(initialExpanded: false);
    _model.mortgageRemainingTextController ??= TextEditingController();
                  ...
                  return SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                                            ...
                                            try {
                                              final result = await FirebaseFunctions
                                                      .instanceFor(
                                                          region: 'us-central1')
                                                  .httpsCallable(
                                                      'computePropertyProjection')
                                                  .call({
                                                "propertyId":
                                                    widget!.propID!.id,
                                              });
                                              _model.cloudFunctionor1 =
                        ...
                        StreamBuilder<List<RentIncreaseYearsRecord>>(
                          stream: queryRentIncreaseYearsRecord(
                            queryBuilder: (rentIncreaseYearsRecord) =>
                                rentIncreaseYearsRecord.orderBy('year'),
                          ),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            if (!snapshot.hasData) {
                            ...
                            List<RentIncreaseYearsRecord>
                                containerRentIncreaseYearsRecordList =
                                snapshot.data!;
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              formatNumber(
                                                                                _model.financialSummary!.totalInvestment,
                                                                                formatType: FormatType.decimal,
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              formatNumber(
                                                                                _model.financialSummary!.allTimeCapitalAppreciation,
                                                                                formatType: FormatType.decimal,
                                                                                decimalType: DecimalType.automatic,
                                                                                currency: '£',
                                                                              ),
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              formatNumber(
                                                                                _model.financialSummary!.allTimeRentalIncome,
                                                                                formatType: FormatType.decimal,
                                                                                decimalType: DecimalType.automatic,
                                                                                currency: '£',
                                                                              ),
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              formatNumber(
                                                                                _model.financialSummary!.allTimeExpenses,
                                                                                formatType: FormatType.decimal,
                                                                                decimalType: DecimalType.automatic,
                                                                                currency: '£',
                                                                              ),
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              formatNumber(
                                                                                _model.financialSummary!.allTimeNetProfit,
                                                                                formatType: FormatType.decimal,
                                                                                decimalType: DecimalType.automatic,
                                                                                currency: '£',
                                                                              ),
                                                                                ...
                                                                                children: [
                                                                                  TextSpan(
                                                                                    text: valueOrDefault<String>(
                                                                                      formatNumber(
                                                                                        _model.financialSummary?.allTimeROI,
                                                                                        formatType: FormatType.decimal,
                                                                                        decimalType: DecimalType.automatic,
                                                                                      ),
                                                                                      '0',
                                                                  ...
                                                                  expanded:
                                                                    ...
                                                                    mainAxisSize:
                                                                        MainAxisSize
                                                                            .max,
                                                                    children: [
                                                                      if ((propertyPropertiesRecord.mortgageRemaining >
                                                                              0.0) &&
                                                                          !_model
                                                                            ...
                                                                            children:
                                                                              ...
                                                                              Padding(
                                                                                ...
                                                                                child: Container(
                                                                                  width: double.infinity,
                                                                                  child: TextFormField(
                                                                                    controller: _model.mortgageRemainingTextController,
                                                            ...
                                                            if (selectedMedia !=
                                                                ...
                                                                selectedMedia.every((m) =>
                                                                    validateFileFormat(
                                                                        ...
                                                                        context))) {
                                                              safeSetState(() =>
                                                                  _model.isDataUploading_userImages =
                                                                      true);
                                                              var selectedUploadedFiles =
                                                                  <FFUploadedFile>[];
                                                              ...
                                                              if (selectedUploadedFiles
                                                                ...
                                                                safeSetState(
                                                                    () {
                                                                  _model.uploadedLocalFiles_userImages =
                                                                      selectedUploadedFiles;
                                                                  _model.uploadedFileUrls_userImages =
                                                                      downloadUrls;
                                                                });
                                                              } else {
                                                                safeSetState(
