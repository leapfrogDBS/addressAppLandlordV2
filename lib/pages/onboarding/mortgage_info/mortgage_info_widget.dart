...
class MortgageInfoWidget extends StatefulWidget {
  const MortgageInfoWidget({
    super.key,
    required this.missingMortgage,
  });

  final List<PropertiesRecord>? missingMortgage;
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Builder(
                        builder: (context) {
                          final property = widget!.missingMortgage!.toList();
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, propertyIndex) {
                              ...
                              return MortgagePromptWidget(
                                ...
                                formattedAddress: propertyItem.addressFormatted,
