...
class PropertyDetailsWidget extends StatefulWidget {
  ...
  final PropertiesRecord? propertyDoc;
...
class _PropertyDetailsWidgetState extends State<PropertyDetailsWidget> {
  ...
  void initState() {
    ...
    _model.averageYearlyCostsTextController ??= TextEditingController();
    _model.averageYearlyCostsFocusNode ??= FocusNode();
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        valueOrDefault<String>(
                          widget!.propertyDoc?.addressFormatted,
                          'address',
                        ),
                        style:
                      ...
                      Text(
                        FFLocalizations.of(context).getText(
                          '46tex3yv' /* To help us generate accurate p... */,
                        ),
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'idplgxyz' /* Enter Optional Title for Prope... */,
                                  ),
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                controller:
                                    _model.averageYearlyCostsTextController,
                                focusNode: _model.averageYearlyCostsFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: true,
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'jfv29rrg' /* Enter average yearly costs */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                focusNode:
                                    _model.mortgageValueRemainingFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: true,
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'dt8j4n7t' /* Enter outstanding mortgage val... */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                                  ...
                                  if (_model.datePicked != null) {
                                    await widget!.propertyDoc!.reference
                                      ...
                                      mortgageRemaining: double.tryParse(_model
                                          .mortgageValueRemainingTextController
                                          .text),
                                      averageYearlyExpenses: double.tryParse(
                                          _model
